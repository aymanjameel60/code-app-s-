...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  void _showSort(){showModalBottomSheet<void>(context:context,showDragHandle:true,builder:(sheetContext)=>SafeArea(child:Column(mainAxisSize:MainAxisSize.min,children:[const Padding(padding:EdgeInsets.all(12),child:Text('الترتيب حسب',style:TextStyle(fontSize:18,fontWeight:FontWeight.w900))),for(final o in const[('relevance','الأكثر صلة'),('price-low','السعر الأقل'),('price-high','السعر الأعلى'),('rating','الأعلى تقييماً'),('discount','الأعلى خصماً')])ListTile(title:Text(o.$2),trailing:_sort==o.$1?const Icon(Icons.check,color:spikeRed):null,onTap:(){setState(()=>_sort=o.$1);Navigator.pop(sheetContext);})])));}
