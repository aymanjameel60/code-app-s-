      ...
      body: SafeArea(
        child: state.when(
          ...
          error: (e, _) => SpikeErrorState(
            message: e.toString(),
            onRetry: () => ref.invalidate(notificationsDataProvider),
          ),
          data: (data) {
                      ...
                      children: [
                        ...
                        if (items.isNotEmpty)
                          Align(
                            ...
                            child: TextButton(
                              onPressed: unread == 0 ? null : () => _readAll(context, ref),
                              child: const Text('قراءة الكل', style: TextStyle(fontSize: 11)),
                            ),
                          ),
                      ],
                    ),
                  ...
                  child: items.isEmpty
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.separated(
                            ...
                            separatorBuilder: (_, __) => const SizedBox(height: SpikeSpacing.sm),
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: dark
                                        ? spikeDarkPanel
                                        : (isUnread ? spikeRed.withValues(alpha: .07) : spikePanel),
                                    borderRadius: BorderRadius.circular(SpikeRadius.card),
                                  ),
                                  child: Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                if (isUnread)
                                                  const CircleAvatar(radius: 4, backgroundColor: spikeRed),
                                              ],
                                            ),
