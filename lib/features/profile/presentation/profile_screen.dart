                ...
                child: Row(children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(logged ? 'مرحباً $name' : 'مرحباً بك في Spike', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, height: 1.7)),
                      if (logged && phone.isNotEmpty) Text(phone, style: const TextStyle(fontSize: 12, height: 1.7)),
                      if (logged && email.isNotEmpty) Text(email, style: const TextStyle(fontSize: 12, height: 1.7)),
                      if (!logged) const Text('سجّل الدخول لمتابعة طلباتك وبياناتك', style: TextStyle(fontSize: 12, height: 1.7)),
                    ]),
                  ),
                ]),
              ),
              Padding(
                ...
                child: Column(children: [
                  ...
                  _row(
                    ...
                    () async {
                      if (!logged) { context.push('/login'); return; }
        ...
        child: SizedBox(
          ...
          child: Padding(
            ...
            child: Row(children: [
              ...
              Expanded(child: Text(label, style: TextStyle(fontSize: 12, color: danger ? spikeRed : null))),
              if (featured)
                Container(
